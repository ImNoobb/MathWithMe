...
Chuong_I_Dai_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_I_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_I_2.png').convert_alpha(),(76,252),lambda: Chuong_I_cmd(6,'dai'))
Chuong_I_Hinh_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_I_2.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_I_2.png').convert_alpha(),(82,497),lambda: Chuong_I_cmd(6,'hinh'))
# Chuong II Button ================================================================= #
...
Chuong_II_Dai_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_II_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_II_2.png').convert_alpha(),(238,252),lambda: Chuong_II_cmd(6,'dai'))
Chuong_II_Hinh_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_II_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_II_2.png').convert_alpha(),(243,497),lambda: Chuong_II_cmd(6,'hinh'))
# Chuong III Button ================================================================= #
...
Chuong_III_Dai_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_III_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_III_2.png').convert_alpha(),(76,317),lambda: Chuong_III_cmd(6,'dai'))
Chuong_III_Hinh_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_III_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_III_2.png').convert_alpha(),(81,560),lambda: Chuong_III_cmd(6,'hinh'))
# Chuong IV Button ================================================================= #
...
Chuong_IV_Dai_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_IV_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_IV_2.png').convert_alpha(),(238,317),lambda: Chuong_IV_cmd(6,'dai'))
Chuong_IV_Hinh_Button = N_Button(pygame.image.load('assets\\buttons\\chuong_IV_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\chuong_IV_2.png').convert_alpha(),(243,560),lambda: Chuong_IV_cmd(6,'hinh'))
...
setting_button = A_Button([pygame.image.load('assets\\buttons\\settings_1.png').convert_alpha(),pygame.image.load('assets\\buttons\\settings_2.png').convert_alpha(),pygame.image.load('assets\\buttons\\settings_3.png').convert_alpha(),pygame.image.load('assets\\buttons\\settings_4.png').convert_alpha(),pygame.image.load('assets\\buttons\\settings_5.png').convert_alpha(),pygame.image.load('assets\\buttons\\settings_6.png').convert_alpha()],0.5,(1280-205,500),settings_cmd)
...
# Bai 6 Buttons === #
def l6_screen_display_dai(bai,y,img):
...
def lop6_bai(bai,chuong):
    ...
    if chuong == 'daiI':
        temp = pygame.image.load(f'assets\\baigiang\\lop6\\bai{bai}.png')
        scroll_y = 0
        while baigiang_running:
            l6_screen_display_dai(bai,0,temp)
	elif chuong == 'daiII':
        temp = pygame.image.load(f'assets\\baigiang\\lop6\\bai{bai}_{chuong}.png')
		scroll_y = 0
		while baigiang_running:
